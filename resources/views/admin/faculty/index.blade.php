        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <a href="{{ route('admin.create.faculty') }}" class="btn btn-outline-primary">Create new <i
  ...
  <div class="modal-dialog" role="document">
     <div class="modal-content">
        ...
        <div class="modal-footer bg-whitesmoke br">
           ...
           <a href="#" class="btn btn-danger" id="deleteFacultyBtn">Delete</a>
        </div>
     </div>
  </div>
</div>
...
<script>
  $('#exampleModal').on('show.bs.modal', function (event) {
     ...
     var facultySlug = button.data('faculty-slug');
     var modal = $(this);
     modal.find('#deleteFacultyBtn').attr('href', '/admin/delete-faculty/' + facultySlug);
  });
</script>
@endsection