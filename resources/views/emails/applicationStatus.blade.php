...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
        <tr>
            <td style="background: #f0575e; padding: 10px 20px;">
                <h1 style="color: #ffffff; text-align: center;">Admission Application Update</h1>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="background: #003399; padding: 20px; text-align: center;">
